...
This project implements four fundamental digital circuit designs in Verilog as part of a Computer Architecture laboratory course. Each experiment progresses in complexity from basic arithmetic circuits to a complete MIPS processor implementation.
